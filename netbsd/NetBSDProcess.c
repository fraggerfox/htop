...
ProcessClass NetBSDProcess_class = {
   .super = {
      .extends = Class(Process),
      .display = Process_display,
      .delete = Process_delete,
      .compare = NetBSDProcess_compare
   },
   .writeField = (Process_WriteField) NetBSDProcess_writeField,
};
...
void NetBSDProcess_writeField(Process* this, RichString* str, ProcessField field) {
   //NetBSDProcess* fp = (NetBSDProcess*) this;
